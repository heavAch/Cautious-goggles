    ...
    bool AreSquaresLegal(int iSrcRow, int iSrcCol, int iDestRow, int iDestCol, GamePiece* GameBoard[8][8]) {
        ...
        if (qpDest == 0) {
            ...
            if (iSrcCol == iDestCol) {
                ...
                if (GetColor() == 'W' && iSrcRow == 1)
                    { if ((iDestRow == iSrcRow + 1) || (iDestRow == iSrcRow + 2))
                        return true;
                    }
                 else if (GetColor() == 'W') {
...
public:
    ...
    void GetNextMove(GamePiece* GameBoard[8][8]) {
        ...
        do {
            system ("cls");
            cout<<endl<<endl<<"       Welcome to Chess Game "<<endl<<endl;
            cout<<"            Keys to symbols used "<<endl<<endl<<endl;
            cout<<" white square = * ";
            cout<<"  black square = blank "<<endl;
            ...
            cout<<"Example: To move left White Knight; type 12 to either 31 or 33 "<<endl<<endl<<endl;
            mqGameBoard.Print();
